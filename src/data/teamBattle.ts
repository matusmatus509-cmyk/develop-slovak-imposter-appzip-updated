...
export const PANTOMIMA_WORDS: string[] = [
  ...
  "Bežkovanie", "Bicyklovanie", "Boxovanie", "Bubnovanie", "Budovanie stanu",
  "Cestovanie vlakom", "Česanie vlasov", "Čistenie okien", "Čítanie knihy",
  "Chirurg", "Cukrár", "Dirigent", "Dojenie kravy", "Dopravný policajt",
  "Fotograf", "Hádzanie šípok", "Hranie na klavír", "Hranie šachu", "Hrobár",
  "Hasič", "Horolezec", "Holiť sa", "Húpať sa", "Chytanie rýb", "Inštalatér",
  "Jazda na koni", "Kaderníčka", "Kamionista", "Kartárka", "Kosenie trávy",
  "Kopanie jamy", "Krájanie cibule", "Kŕmenie vtákov", "Kuchár", "Kúzelník",
  "Kúpanie psa", "Lyžovanie", "Maľovanie obrazu", "Maliar izieb", "Masér",
  "Zametanie", "Miešanie kariet", "Mikuláš", "Mím", "Umývanie riadu",
  "Nakupovanie", "Nalievanie vína", "Natieranie chleba", "Nosenie okuliarov",
  "Oranie", "Oprava auta", "Padanie na ľade", "Pečenie koláča", "Pilot",
  "Pletenie svetra", "Plávanie", "Poľovník", "Polievanie kvetov",
  "Pranie v rukách", "Predavač", "Prechádzka so psom", "Prebaľovanie bábätka",
  "Programátor", "Písanie na stroji", "Rezanie dreva", "Rybár", "Rúbanie dreva",
  "Sadenie stromu", "Skákanie cez švihadlo", "Skladanie lietadielka",
  "Sledovanie hokeja", "Smečovanie", "Smetiar", "Snívanie", "Spievanie v sprche",
  "Spisovateľ", "Sprchovanie", "Sťahovanie nábytku", "Strihanie papiera",
  "Surfing", "Svadobný tanec", "Štrikovanie", "Tancovanie baletu", "Tenista",
  "Tlačenie kočíka", "Trhanie zubov", "Učiteľ", "Umývanie zubov", "Upratovačka",
  "Varenie kávy", "Vešanie bielizne", "Veštenie", "Vetranie", "Vodár",
  "Vyšívanie", "Výmena žiarovky", "Záhradník", "Zvárač", "Žehlenie",
  // Predmety a veci
  "Akvárium", "Angličák", "Anténa", "Automobil", "Balón", "Banán", "Barle",
  "Batoh", "Bicykel", "Bič", "Budík", "Bubon", "Čajník", "Činka", "Dáždnik",
  "Dialkový ovládač", "Diár", "Diktafón", "Dvere", "Fľaša", "Fotoaparát",
  "Fúrik", "Fén na vlasy", "Gitara", "Glóbus", "Guma", "Hračka", "Hrebeň",
  "Hubka na riad", "Husle", "Chladnička", "Chlieb", "Ihla", "Injekcia",
  "Igelitka", "Jojo", "Kábel", "Kaktus", "Kalendár", "Kľúč", "Klobúk",
  "Kniha", "Koberec", "Kompas", "Kočík", "Kosa", "Kostra", "Kôš", "Kotva",
  "Krabica", "Krieda", "Pálka", "Krokomer", "Kufor", "Kladivo", "Klince",
  "Lampa", "Laso", "Lavička", "Lepidlo", "Obálka", "Lopata", "Lopta", "Lupa",
  "Lyžica", "Magnet", "Magnetofón", "Maskara", "Matrac", "Meč", "Mikroskop",
  "Minca", "Mobil", "Píla", "Pištoľ", "Plachta", "Pohár", "Pomáda", "Prsteň",
  "Puzdro", "Radiátor", "Raketa", "Remeň", "Rúž", "Ruksak", "Rukavice",
  "Ruleta", "Sekera", "Slúchadlá", "Sviečka", "Sponka", "Spací vak", "Stan",
  "Stolička", "Stôl", "Strúhadlo", "Teplomer", "Topánka", "Traktor", "Trubka",
  "Váza", "Ventilátor", "Vidlička", "Zrkadlo",
  // Zvieratá
  "Aligátor", "Antilopa", "Baran", "Bobor", "Bocian", "Včela", "Medveď",
  "Býk", "Cikáda", "Čajka", "Červík", "Delfín", "Dinosaurus", "Diviak",
  "Drozd", "Dudok", "Ďateľ", "Plameniak", "Fretka", "Gekón", "Gepard",
  "Gorila", "Grizly", "Had", "Škrečok", "Holub", "Hroch", "Hus", "Húsenica",
  "Chameleón", "Chobotnica", "Jaguár", "Jastrab", "Jašterica", "Jeleň",
  "Ježko", "Kamzík", "Kačka", "Kengura", "Kobra", "Kohút", "Koala", "Komár",
  "Kôň", "Kosatka", "Koza", "Krab", "Krava", "Krokodíl", "Králik", "Krtko",
  "Kukučka", "Kuna", "Kurča", "Korytnačka", "Lama", "Lasica", "Leňochod",
  "Lev", "Leopard", "Líška", "Los", "Mačka", "Mamut", "Medúza", "Mravec",
  "Morka", "Mrož", "Mucha", "Myš", "Netopier", "Nosorožec", "Orol", "Osa",
  "Somár", "Ovca", "Páv", "Pavúk", "Pelikán", "Tučniak", "Pes", "Piraňa",
  "Pásavec", "Potkan", "Prasa", "Pštros", "Ropucha", "Ryba", "Salamandra",
  "Srna", "Sup", "Slon", "Slimák", "Sova", "Sršeň", "Svišť", "Sysel",
  "Šimpanz", "Škorpión", "Ťava", "Tiger", "Tuleň", "Užovka",
  // Emócie a stavy
  "Agresivita", "Arogancia", "Bezradnosť", "Bezmocnosť", "Bláznivosť",
  "Bohatstvo", "Bolestivý plač", "Bolesť zubov", "Bojazlivosť", "Bdelosť",
  "Ctižiadosť", "Chlad", "Chudoba", "Depresia", "Dobrosrdečnosť", "Dojatie",
  "Dočasnosť", "Drzosť", "Elán", "Eufória", "Fantázia", "Falošnosť",
  "Frustrácia", "Hnev", "Hrdosť", "Hrubosť", "Hrôza", "Hlad", "Hluchota",
  "Hystéria", "Ignorancia", "Irónia", "Istota", "Lakomosť", "Láska",
  "Láskavosť", "Lenivosť", "Letargia", "Lojalita", "Ľútosť", "Márnomyselnosť",
  "Melanchólia", "Mierumilovnosť", "Mladosť", "Mlčanlivosť", "Múdrosť",
  "Namyslenosť", "Nadšenie", "Naivita", "Náladovosť", "Napätie", "Narcizmus",
  "Násilie", "Nedôvera", "Nedočkavosť", "Neistota", "Nemoc", "Nenávisť",
  "Neochota", "Nepokoj", "Nervozita", "Nespavosť", "Nešikovnosť", "Nevinnosť",
  "Nuda", "Núdza", "Obava", "Obetavosť", "Obdiv", "Obžerstvo", "Odvaha",
  "Odpor", "Odpustenie", "Optimizmus", "Opilosť", "Osamelosť", "Ostražitosť",
  "Ostýchavosť", "Pýcha", "Panika", "Paranoja", "Pesimizmus", "Plačlivosť",
  "Pokora", "Pokoj", "Pomstychtivosť", "Porážka", "Prekvapenie", "Previnilosť",
  "Radosť", "Rozčúlenie", "Rozpačitosť", "Roztržitosť", "Smútok", "Smäd",
  "Strach", "Súcit", "Sklamanie", "Slepačie srdce", "Smiech", "Spokojnosť",
  "Staroba", "Sústredenie",
  // Abstraktné pojmy a popkultúra
  "Batman", "Červená Čiapočka", "Dracula", "Harry Potter", "Homer Simpson",
  "Hulk", "James Bond", "Janko a Marienka", "Ježiško", "Kat", "Kráľ",
  "Kráľovná", "Máša a medveď", "Mimoni", "Múmia", "Pirát", "Popoluška",
  "Princezná", "Robocop", "Robin Hood", "Sherlock Holmes", "Shrek",
  "Snehulienka", "Spiderman", "Superman", "Tarzan", "Upír", "Vodník",
  "Zaklínač", "Zombie", "Zoro pomstiteľ", "Apokalypsa", "Beztiažový stav",
  "Budúcnosť", "Čas", "Čierna diera", "Dedina", "Demokracia", "Dovolenka",
  "Duch", "Džungľa", "Ekológia", "Elektrika", "Evolúcia", "Geometria",
  "Gravitácia", "Hypnóza", "Chaos", "Ilúzia", "Inflácia", "Internet",
  "Katastrofa", "Koniec sveta", "Korupcia", "Kozmos", "Krajina", "Kríza",
  "Labyrint", "Magnetizmus", "Minulosť", "Mier", "Mýtus", "Nadprirodzeno",
  "Narodeniny", "Nekonečno", "Osud", "Paríž", "Počasie", "Pohreb", "Politika",
  "Púšť", "Radiácia", "Raj", "Romantika", "Sloboda", "Smrť", "Sny",
  "Snehová búrka", "Sobota", "Sopka", "Spravodlivosť", "Svadba", "Šport",
  "Tajomstvo", "Trh", "Typografia", "Umenie", "Úspech", "Vianoce", "Vietor",
  "Víkend", "Vlna horúčav", "Vojna", "Voľby", "Vesmír", "Zemetrasenie",
  "Zima", "Zlato", "Zmŕtvychvstanie", "Znamenie", "Spln mesiaca",
  "Čierna mačka", "Piatok trinásteho", "Šťastný koniec",
];
