...
const EASY_CARDS = [
  ...
  "Kniha", "Zošit", "Ceruzka", "Pero", "Guma", "Pravítko", "Nožnice", "Lepidlo", "Mapa", "Peračník",
  "Televízor", "Telefón", "Fotoaparát", "Chladnička", "Práčka", "Sporák", "Mikrovlnka", "Vysávač", "Žehlička", "Budík",
  ...
  "Plachetnica", "Parník", "Prievoz", "Vor", "Horkovzdušný balón", "Padák", "Rogalo", "Vzducholoď", "Rýchlik", "Vozík",
...
const MEDIUM_CARDS = [
  // Postavy a povolania
  "Astronaut", "Robot", "Zombie", "Ninja", "Detektív", "Špión", "Tajný agent", "Vedec", "Archeológ", "Osobný strážca",
  ...
  "Modelka", "Vizážistka", "Manikérka", "Masér", "Fitnes tréner", "Baletka", "Operný spevák", "Rocková hviezda", "Diskdžokej", "Pouličný umelec",
  ...
  "Skok s lanom", "Parašutizmus", "Paragliding", "Lezenie na stene", "Parkour", "Vzdušná akrobacia", "Preteky na korčuliach", "Jazda na jednokolke", "Chôdza na chodúľoch", "Skoky do vody",
  ...
  "Orchester", "Dychová hudba", "Rocková kapela", "Ľudový tanec", "Balet", "Stepovanie", "Breakdance", "Salsa", "Tango", "Valčík",
  ...
  "Pracovný pohovor", "Prvý pracovný deň", "Pracovná porada", "Telefonát s obrazom", "Písanie na tabuli", "Zaseknutá tlačiareň", "Prestávka na kávu", "Školská skúška", "Písomka", "Vysvedčenie",
  ...
  "Autoumyváreň", "Autoservis", "Pneuservis", "Čistiareň", "Kvetinárstvo", "Mäsiarstvo", "Papiernictvo", "Železiarstvo", "Zverimex", "Požičovňa lyží",
  ...
  "Dron", "Robotický vysávač", "Hrací automat", "Fotoaparát so statívom", "Náramkové hodinky", "Selfie palica", "Bezdrôtové slúchadlá", "Hudobné klávesy", "Filmová kamera", "Premietačka",
  ...
  "Silvestrovský ohňostroj", "Vianočná kapustnica", "Veľkonočná šibačka", "Fašiangový sprievod", "Stavanie mája", "Vynášanie Morény", "Vinobranie", "Tekvica na Halloween", "Adventný venec", "Narodeninová sviečka",
  ...
  "Súťaž v jedení", "Súťaž krásy", "Beh vo vreciach", "Hádzanie vajíčkom", "Skákanie vo vreci", "Hľadanie vajíčok", "Tanečná súťaž", "Karaoke súťaž", "Kvízový večer", "Turnaj v šípkach",
  ...
  "Pretekárske auto", "Motokára", "Terénne pretekárske auto", "Historické auto", "Limuzína", "Kabriolet", "Dodávka", "Dvojposchodový autobus", "Trolejbus", "Snežná rolba",
  ...
  "Reťazový kolotoč", "Ruské koleso", "Vodná skluzavka", "Autodrom", "Strelnica", "Skákací hrad", "Lanový park", "Kabína pilota", "Trenažér", "Vláčik v lunaparku",
  ...
  "Tlačenie kočíka", "Prebaľovanie", "Kŕmenie bábätka", "Uspávanie dieťaťa", "Detská stolička", "Cumlík", "Dojčenská fľaška", "Hranie s hrkálkou", "Nosenie dieťaťa", "Prvé zúbky",
  "Kúpanie psa", "Strihanie srsti", "Čistenie klietky", "Čistenie akvária", "Ťahanie na vodítku", "Hádzanie loptičky", "Hladenie mačky", "Podávanie labky", "Aportovanie", "Mačka v prepravke",
...
const HARD_CARDS = [
  ...
  "Iluzionista", "Gladiátor", "Sochár", "Kaskadér", "Alchymista", "Astronóm", "Hľadač fosílií", "Jaskynný bádateľ", "Hodinár", "Sklár",
  "Múmia", "Chameleón", "Sfinga", "Minotaurus", "Kentaur", "Gryf", "Fénix", "Bazilisk", "Kraken", "Hydra",
  "Mrakodrap", "Džungľa", "Púšť", "Tundra", "Kráter", "Labyrint", "Katakomby", "Zrúcanina", "Hvezdáreň", "Akvadukt",
  "Časostroj", "Snehová guľa", "Kaleidoskop", "Gramofón", "Metronóm", "Trezor", "Trojzubec", "Kuša", "Katapult", "Periskop",
  "Ohňová šou", "Zaklínanie hada", "Chôdza po skle", "Únik z reťazí", "Kúzelnícky králik", "Levitácia", "Veštenie z ruky", "Krotenie tigra", "Hádzanie nožom", "Kúzlo s kartami",
  "Biatlon", "Triatlon", "Desaťboj", "Vodné pólo", "Synchronizované plávanie", "Skoky z mostíka", "Boby", "Skeleton", "Sumo", "Rodeo",
  "Rytiersky turnaj", "Plavba Kolumba", "Pristátie na Mesiaci", "Egyptská hrobka", "Rímske kúpele", "Vikingská plavba", "Hľadanie zlata", "Kamenná doba", "Stredoveký trh", "Faraónova maska",
  "Vesmírna prechádzka", "Astronaut vo vesmíre", "Zatmenie Slnka", "Polárna žiara", "Padajúca hviezda", "Kométa", "Prstence Saturna", "Mliečna cesta", "Slnečná sústava", "Kráter na Mesiaci",
  "Mravenisko", "Termitisko", "Vosie hniezdo", "Bobria hrádza", "Pavučina", "Kokón", "Larva", "Kukla", "Kŕdeľ vtákov", "Roj včiel",

  // Náročné scény
  "Útek z väzenia", "Záchrana tonúceho", "Hasenie požiaru", "Vyprostenie z auta", "Zásah horskej služby", "Pátranie so psom", "Núdzové pristátie", "Vzbura na lodi", "Potopenie lode", "Svetlica",
  ...
  "Tajná misia", "Odtlačok prsta", "Sledovanie podozrivého", "Ukrytý mikrofón", "Falošný pas", "Prevlek za čašníka", "Lúpež v múzeu", "Nočná hliadka", "Bezpečnostná kamera", "Únik po lane",
  "Salto na trapéze", "Lietajúci trapéz", "Klaunský pád", "Ľudská pyramída", "Králik z klobúka", "Zmiznutie v dyme", "Kúzelnícka asistentka", "Ohňová obruč", "Slon na pódiu", "Tuleň s loptou",
  ...
  "Operácia na sále", "Resuscitácia", "Prevoz sanitkou", "Odber krvi", "Zubná vrtačka", "Vyšetrenie očí", "Nasadenie sadry", "Prenos na nosidlách", "Zásah záchranárov", "Záchrana vrtuľníkom",
  "Štart rakety", "Odpočítavanie pred štartom", "Pristátie modulu", "Vlajka na Mesiaci", "Oprava vesmírnej lode", "Návrat do atmosféry", "Prílet mimozemšťanov", "Letiaci tanier", "Mechanické rameno", "Prilba astronauta",
  "Trhlina v ľade", "Prasknutá priehrada", "Lesný požiar", "Zamrznutý vodopád", "Rozvodnená rieka", "Zosuv skál", "Búrka na mori", "Stred hurikánu", "Ľadové krúpy", "Blesk do stromu",
  ...
  "Umývač výškových okien", "Kaskadér na motorke", "Lanový záchranár", "Jaskynný potápač", "Horský záchranár", "Baník v šachte", "Rybár na oceáne", "Hasič v dyme", "Ohňový tanečník", "Krotiteľ býkov",
  ...
  "Skok s padákom", "Skok z mosta", "Lezenie bez lana", "Prejazd ohnivou obručou", "Silák so závažím", "Ležanie na klincoch", "Ohýbanie tyče", "Chôdza po uhlíkoch", "Balansovanie s taniermi", "Hádzanie sekerou",
  ...
  "Pokus so sopkou", "Archeológ pri vykopávkach", "Pozorovanie hviezd", "Potápač pri vraku", "Hľadanie drahokamov", "Meranie dažďa", "Miešanie elixíru", "Skúmanie kvetov", "Pozorovanie zvierat", "Pozorovanie vtákov",
  ...
  "Zaseknuté dvere", "Prilepená topánka", "Zamotaná hadica", "Zamotaný kábel", "Auto v bahne", "Mačka na konári", "Kĺzanie po ľade", "Pošmyknutie na šupke", "Stúpenie na hrable", "Švihadlo okolo nôh",
