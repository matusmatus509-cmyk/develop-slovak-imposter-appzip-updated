...
const MINIGAMES: MenuGame[] = [
  ...
  { screen: "slovnarosada", title: "Slovné šarády", description: "Vysvetľujte slová bez použitia ich názvu a zbierajte body.", icon: "gamepad", color: "from-purple-500 to-indigo-600" },
  ...
  { screen: "pismeno", title: "Slovo na písmeno", description: "Kategória, písmeno a krátky čas na odpoveď.", icon: "tag", color: "from-amber-400 to-orange-600", badge: "Nové" },
  { screen: "patzadesat", title: "5 za 10", description: "Vymenujte päť odpovedí v nastavenom čase.", icon: "timer", color: "from-emerald-400 to-green-700", badge: "Nové" },
