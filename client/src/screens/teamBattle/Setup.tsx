    ...
    <PartyBackdrop>
      <main className="mobile-settings mobile-party-settings party-battle-settings scroll-panel h-full overflow-y-auto px-5 pb-8 pt-[max(1.25rem,env(safe-area-inset-top))]">
        <div className="mx-auto w-full max-w-md">
          ...
          {/* Obdĺžnikový hero obrázok — rovnaký jazyk ako pri minihrách (game-setup-hero). */}
          <div className="game-setup-hero relative mt-5 h-48 overflow-hidden rounded-[2rem] border border-white/15 shadow-2xl">
            <img
              src={partyModeArtV2}
              alt=""
              aria-hidden="true"
            ...
            <div className="absolute inset-x-5 bottom-5">
              <span className="quick-game-signature mb-3 inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-[8px] font-black uppercase tracking-[.2em] text-violet-200 backdrop-blur" style={{ borderColor: "rgba(167,139,250,.45)", background: "rgba(139,92,246,.18)" }}>
