/**
 * Jazykové prepisy pre svetový balík. Anglické skladby dedia `en`; interpreti
 * nižšie spievajú v inom jazyku a potrebujú správny provider store routing.
 */
export const WORLD_SONG_ARTIST_LANGUAGES = {
  "Domenico Modugno": "it",
  "Toto Cutugno": "it",
  ...
  "Renato Carosone": "it",
  Mina: "it",
  "Mina & Alberto Lupo": "it",
  "Gianna Nannini & Edoardo Bennato": "it",
  "2NE1": "other",
  BIGBANG: "other",
  "Girls' Generation": "other",
  "Wonder Girls": "other",
  "Super Junior": "other",
  KARA: "other",
  HyunA: "other",
  ...
  "Barbara Pravi": "fr",
  Go_A: "other",
  "Kalush Orchestra": "other",
  "Salvador Sobral": "pt",
  "Marija Šerifović": "other",
  Hadise: "other",
  Mandinga: "other",
  Chanel: "es",
  Konstrakta: "other",
  "Verka Serduchka": "other",
  "Rubén Blades": "es",
  "Willie Colón": "es",
  "Celia Cruz & Johnny Pacheco": "es",
  "Celia Cruz": "es",
  "La India & Marc Anthony": "es",
  "Marc Anthony": "es",
  "Son by Four": "es",
  Aventura: "es",
  "Prince Royce": "es",
  "Juan Luis Guerra 4.40": "es",
  "Chichi Peralta": "es",
  Chocolate: "es",
  "Proyecto Uno": "es",
  "Los Hermanos Rosario": "es",
  "Lalo Rodríguez": "es",
  "Joe Arroyo": "es",
  "Grupo Niche": "es",
  "Frankie Ruiz": "es",
  "Gilberto Santa Rosa": "es",
  "Don Omar": "es",
  ...
  "Zion & Lennox": "es",
  "Luny Tunes": "es",
  "Daddy Yankee, Wisin & Yandel, Zion, Héctor el Father & Tonny Tun Tun": "es",
  "R.K.M & Ken-Y": "es",
  "Angel & Khriz": "es",
  "Wisin & Yandel": "es",
  "Wisin & Yandel feat. Romeo Santos": "es",
  "Mariya Takeuchi": "other",
  "Miki Matsubara": "other",
  "Kyu Sakamoto": "other",
  "Kenshi Yonezu": "other",
  YOASOBI: "other",
  Ikimonogakari: "other",
  "Hikaru Utada": "other",
  "Kyary Pamyu Pamyu": "other",
  AKB48: "other",
  "OFFICIAL HIGE DANDISM": "other",
  "Fujii Kaze": "other",
  "Gen Hoshino": "other",
  "Kana Hanazawa": "other",
  "Yoko Takahashi": "other",
  LiSA: "other",
  Aimer: "other",
  "Creepy Nuts": "other",
  Suchmos: "other",
  ...
  Yuuri: "other",
  "Daler Mehndi": "other",
  "A.R. Rahman feat. Sukhwinder Singh, Tanvi Shah, Mahalakshmi Iyer & Vijay Prakash":
    "other",
  "Panjabi MC": "other",
  Tarkan: "other",
  "Miriam Makeba": "other",
...
Più bella cosa|Eros Ramazzotti|1996|pop|easy|hum
...
Tu vuò fà l'americano|Renato Carosone|1956|oldies|easy|hum
Tintarella di luna|Mina|1959|oldies|medium|hum
...
Ojalá Que Llueva Café|Juan Luis Guerra 4.40|1989|latin|medium|hum
El Niágara en Bicicleta|Juan Luis Guerra 4.40|1998|latin|medium|hum
...
Una Aventura|Grupo Niche|1990|latin|medium|hum
Gotas de Lluvia|Grupo Niche|1995|latin|medium|hum
La Cura|Frankie Ruiz|1985|latin|medium|hum
Tú Con Él|Frankie Ruiz|1985|latin|medium|hum
...
Te Regalo Amores|R.K.M & Ken-Y|2008|latin|medium|hum
Ven Báilalo|Angel & Khriz|2004|latin|easy|hum
Na de Na|Angel & Khriz|2008|latin|medium|hum
Sexy Movimiento|Wisin & Yandel|2007|latin|easy|hum
